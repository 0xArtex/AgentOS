...
- **register a domain**
- buy and operate an **X/Twitter** account (post, reply, follow), or connect and operate a **TikTok** account (`connect --server`, post, schedule, follow, like, delete, profile, analytics, and **hooks** — what's working in a **niche** across TikTok, $0.05, needing no account history and answered from a niche corpus that collects itself; or which of your own caption openings beat the account's own median, $0.001) — TikTok accounts are connected, not bought
