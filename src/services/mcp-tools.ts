  ...
  addTool(server, 
    "tiktok_post",
    {
      ...
      inputSchema: {
        ...
        caption: z.string(),
        video_base64: z.string().optional().describe("Base64 video bytes (or provide video_url)"),
        video_url: z.string().optional().describe("Public URL to the video (or provide video_base64)"),
        proxy_session_id: z.string().optional(),
